...
configure_vision_model() {
    ...
    case $model_choice in
        1)
            ...
            if [ -z "$api_key" ]; then
                print_warning "未输入 API Key，使用默认配置"
...
export DOUBAO_BATCH_ENDPOINT="ep-bi-20251202180029-rfkcl"

# 通用配置 (兼容 OpenAI 格式)
export PHONE_AGENT_BASE_URL="\$DOUBAO_API_URL"
export PHONE_AGENT_API_KEY="\$DOUBAO_API_KEY"
export PHONE_AGENT_MODEL="\$DOUBAO_MODEL"
